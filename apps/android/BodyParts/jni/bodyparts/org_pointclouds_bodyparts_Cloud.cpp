#include "org_pointclouds_bodyparts_Cloud.h"
...
Java_org_pointclouds_bodyparts_Cloud_cacheIds
...
JNIEXPORT void JNICALL
Java_org_pointclouds_bodyparts_Cloud_create
...
JNIEXPORT void JNICALL
Java_org_pointclouds_bodyparts_Cloud_free
  (JNIEnv * env, jobject object)
{
...
JNIEXPORT void JNICALL
Java_org_pointclouds_bodyparts_Cloud_readColors
...
Java_org_pointclouds_bodyparts_Cloud_getHeight
  (JNIEnv * env, jobject object)
{
  Cloud * ptr = getPtr<Cloud> (env, object);
...
JNIEXPORT jint JNICALL
Java_org_pointclouds_bodyparts_Cloud_getWidth
  (JNIEnv * env, jobject object)
{
  Cloud * ptr = getPtr<Cloud> (env, object);
  return ptr->getWidth();
