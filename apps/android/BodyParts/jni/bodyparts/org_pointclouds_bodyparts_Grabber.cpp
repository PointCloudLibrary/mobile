#include "org_pointclouds_bodyparts_Grabber.h"
...
Java_org_pointclouds_bodyparts_Grabber_cacheIds
...
JNIEXPORT void JNICALL
Java_org_pointclouds_bodyparts_Grabber_free
...
Java_org_pointclouds_bodyparts_Grabber_createOpenNIGrabber
  (JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jobject JNICALL
Java_org_pointclouds_bodyparts_Grabber_createFileGrabber
...
JNIEXPORT void JNICALL
Java_org_pointclouds_bodyparts_Grabber_start
  (JNIEnv * env, jobject object)
{
  Grabber * ptr = getPtr<Grabber>(env, object);
  ptr->start();
