...
public class Main extends Activity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        color_ref.setAdapter(new BodyPartLabelAdapter(
                this, android.R.layout.simple_list_item_1, BodyPartLabel.values()));
    ...
    private class StateRequestingPermission extends State {
        private static final String ACTION_USB_PERMISSION = "org.pointclouds.bodyparts.USB_PERMISSION";
