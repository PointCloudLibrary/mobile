...
After that, run the following in this directory (<root> means the full path
to the working copy root):

export NDK_MODULE_PATH=<root>/3rdparty/android/ndk-modules
ndk-build
